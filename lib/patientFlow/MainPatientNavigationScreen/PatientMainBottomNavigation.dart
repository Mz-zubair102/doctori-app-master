      ...
      child: Row(
        ...
        children: [
          GestureDetector(
            ...
            child: CircleAvatar(
              backgroundColor: selectedScreen==0?Color(0xff0066FF):Colors.transparent,
              radius: 22,
          ...
          GestureDetector(
            ...
            child: CircleAvatar(
              backgroundColor: selectedScreen==1?Color(0xff0066FF):Colors.transparent,
              radius: 22,
              child: SvgPicture.asset(
                bottomIcons[1],
          ...
          GestureDetector(
            ...
            child: CircleAvatar(
              backgroundColor: selectedScreen==2?Color(0xff0066FF):Colors.transparent,
              radius: 22,
              child: SvgPicture.asset(
                bottomIcons[2],
          ...
          GestureDetector(
            ...
            child: CircleAvatar(
              backgroundColor: selectedScreen==3?Color(0xff0066FF):Colors.transparent,
              radius: 22,
              child: SvgPicture.asset(
                bottomIcons[3],
