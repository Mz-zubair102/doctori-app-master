...
class BookingAppointmentDetails extends StatelessWidget {
  BookingAppointmentDetails({Key? key}) : super(key: key);
                  ...
                  RichText(
                    text: TextSpan(
                      children: [
                        TextSpan(
                            text: '\$ ',
                            style: TextStyle(color: Color(0xff0EBE7F), fontSize: 15, fontWeight: FontWeight.bold)),
                        TextSpan(
                            text: '28.00',
  ...
  Widget _buildConfirm(BuildContext context) {
    return Container(
      ...
      child: CustomElevatedButton(
        ...
        text: "Confirm",
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => PatientPaymentScreen(),));
        },
