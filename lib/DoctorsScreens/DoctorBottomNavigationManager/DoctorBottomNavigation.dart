      ...
      child: Row(
        ...
        children: [
          GestureDetector(
            ...
            child: CircleAvatar(
              radius: 23,
              backgroundColor: selectedScreens==0?Color(0xff0066FF):Colors.transparent,
          ...
          GestureDetector(
            ...
            child: CircleAvatar(
              radius: 23,
              backgroundColor: selectedScreens==1?Color(0xff0066FF):Colors.transparent,
              child: SvgPicture.asset(
                  bottomIcons[1],
          ...
          GestureDetector(
            ...
            child: CircleAvatar(
              radius: 23,
              backgroundColor: selectedScreens==2?Color(0xff0066FF):Colors.transparent,
              child: SvgPicture.asset(
                  bottomIcons[2],
